...
* @param {NUMBER}  size : radius of the vehicle.
* @return {OBJECT}  : return a Vector in the meaning of the geometrical object
* Note that vehicle is considered as a flat disc.
* So its hit box is fit in a circle.
*/
